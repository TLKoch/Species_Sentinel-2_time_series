## ---------------------------
##
## Script name: 11_variability_evergreen_deciduous
##
## Purpose of script: Retrieve standard deviations for evergreen and deciduous species groups separately. 
##
...
for (i in 1:length(band_names)) {
  all_df_subset <-    evergreen_df[, c(1, grep(band_names[[i]], colnames(evergreen_df)))]
  ...
  write.csv2(sd_per_intra_group[[i]], paste0("01_data/10_preprocessed/time_points_separability_evaluation/",
                                             "norm_2020_evergreen_intraspecific_sd_", band_names[[i]], ".csv"), row.names = FALSE)
  ...
  write.csv2(mean_per_intra_time_point[[i]], paste0("01_data/10_preprocessed/time_points_separability_evaluation/",
                                                    "norm_2020_evergreen_intraspecific_mean_sd_", band_names[[i]], ".csv"), row.names = FALSE)
  ...
  write.csv2(median_per_intra_group[[i]], paste0("01_data/10_preprocessed/time_points_separability_evaluation/",
                                                 "norm_2020_evergreen_intraspecific_median_", band_names[[i]], ".csv"), row.names = FALSE)
  ...
  write.csv2(difference_table, paste0("01_data/10_preprocessed/time_points_separability_evaluation/",
                                      "norm_2020_evergreen_interspecific_differences_of_medians_per_group_", band_names[[i]], ".csv"), row.names = FALSE)
  ...
  write.csv2(diff_mean, paste0("01_data/10_preprocessed/time_points_separability_evaluation/",
                               "norm_2020_evergreen_interspecific_mean_of_sd_of_medians_per_group_", band_names[[i]], ".csv"), row.names = FALSE)
}
...
median_per_intra_group <- list()
for (i in 1:length(band_names)) {
  all_df_subset <-    deciduous_df[, c(1, grep(band_names[[i]], colnames(deciduous_df)))]
  
  ## intraspecific
  sd_per_intra_group[[i]] <- all_df_subset |> group_by(species) |> summarise(across(everything(), sd, na.rm = TRUE))
  write.csv2(sd_per_intra_group[[i]], paste0("01_data/10_preprocessed/time_points_separability_evaluation/",
                                             "norm_2020_deciduous_intraspecific_sd_", band_names[[i]], ".csv"), row.names = FALSE)
  
  mean_per_intra_time_point[[i]] <- summarise(sd_per_intra_group[[i]], across(-species, mean))
  write.csv2(mean_per_intra_time_point[[i]], paste0("01_data/10_preprocessed/time_points_separability_evaluation/",
                                                    "norm_2020_deciduous_intraspecific_mean_sd_", band_names[[i]], ".csv"), row.names = FALSE)
  ...
  median_per_intra_group[[i]] <- all_df_subset |> group_by(species) |> summarise(across(everything(), median, na.rm = TRUE))
  write.csv2(median_per_intra_group[[i]], paste0("01_data/10_preprocessed/time_points_separability_evaluation/",
                                                 "norm_2020_deciduous_intraspecific_median_", band_names[[i]], ".csv"), row.names = FALSE)
  ...
  write.csv2(difference_table, paste0("01_data/10_preprocessed/time_points_separability_evaluation/",
                                      "norm_2020_deciduous_interspecific_differences_of_medians_per_group_", band_names[[i]], ".csv"), row.names = FALSE)
  ...
  write.csv2(diff_mean, paste0("01_data/10_preprocessed/time_points_separability_evaluation/",
                               "norm_2020_deciduous_interspecific_mean_of_sd_of_medians_per_group_", band_names[[i]], ".csv"), row.names = FALSE)
}
...
for (i in 1:length(band_names)) {
  ...
  sd_per_intra_group[[i]] <- all_df_subset |> group_by(species) |> summarise(across(everything(), sd, na.rm = TRUE))
  write.csv2(sd_per_intra_group[[i]], paste0("01_data/10_preprocessed/time_points_separability_evaluation/",
                                             "norm_2019_evergreen_intraspecific_sd_", band_names[[i]], ".csv"), row.names = FALSE)
  
  mean_per_intra_time_point[[i]] <- summarise(sd_per_intra_group[[i]], across(-species, mean))
  write.csv2(mean_per_intra_time_point[[i]], paste0("01_data/10_preprocessed/time_points_separability_evaluation/",
                                                    "norm_2019_evergreen_intraspecific_mean_sd_", band_names[[i]], ".csv"), row.names = FALSE)
  ...
  median_per_intra_group[[i]] <- all_df_subset |> group_by(species) |> summarise(across(everything(), median, na.rm = TRUE))
  write.csv2(median_per_intra_group[[i]], paste0("01_data/10_preprocessed/time_points_separability_evaluation/",
                                                 "norm_2019_evergreen_intraspecific_median_", band_names[[i]], ".csv"), row.names = FALSE)
  ...
  write.csv2(difference_table, paste0("01_data/10_preprocessed/time_points_separability_evaluation/",
                                      "norm_2019_evergreen_interspecific_differences_of_medians_per_group_", band_names[[i]], ".csv"), row.names = FALSE)
  ...
  write.csv2(diff_mean, paste0("01_data/10_preprocessed/time_points_separability_evaluation/",
                               "norm_2019_evergreen_interspecific_mean_of_sd_of_medians_per_group_", band_names[[i]], ".csv"), row.names = FALSE)
}
...
for (i in 1:length(band_names)) {
  ...
  sd_per_intra_group[[i]] <- all_df_subset |> group_by(species) |> summarise(across(everything(), sd, na.rm = TRUE))
  write.csv2(sd_per_intra_group[[i]], paste0("01_data/10_preprocessed/time_points_separability_evaluation/",
                                             "norm_2019_deciduous_intraspecific_sd_", band_names[[i]], ".csv"), row.names = FALSE)
  
  mean_per_intra_time_point[[i]] <- summarise(sd_per_intra_group[[i]], across(-species, mean))
  write.csv2(mean_per_intra_time_point[[i]], paste0("01_data/10_preprocessed/time_points_separability_evaluation/",
                                                    "norm_2019_deciduous_intraspecific_mean_sd_", band_names[[i]], ".csv"), row.names = FALSE)
  ...
  median_per_intra_group[[i]] <- all_df_subset |> group_by(species) |> summarise(across(everything(), median, na.rm = TRUE))
  write.csv2(median_per_intra_group[[i]], paste0("01_data/10_preprocessed/time_points_separability_evaluation/",
                                                 "norm_2019_deciduous_intraspecific_median_", band_names[[i]], ".csv"), row.names = FALSE)
  ...
  write.csv2(difference_table, paste0("01_data/10_preprocessed/time_points_separability_evaluation/",
                                      "norm_2019_deciduous_interspecific_differences_of_medians_per_group_", band_names[[i]], ".csv"), row.names = FALSE)
  ...
  write.csv2(diff_mean, paste0("01_data/10_preprocessed/time_points_separability_evaluation/",
                               "norm_2019_deciduous_interspecific_mean_of_sd_of_medians_per_group_", band_names[[i]], ".csv"), row.names = FALSE)
}
