## ---------------------------
##
## Script name: 12_variability_evergreen_deciduous_plot
##
...
ggsave(paste0("00_documentation/figures/differences/", "norm_2020_evergreen_mean_sd_facet_all_bands",".jpeg"), 
       width= 12,
       height= 6, dpi = 900) 
...
ggsave(paste0("00_documentation/figures/differences/", "norm_2020_deciduous_mean_sd_facet_all_bands",".jpeg"), 
       width= 12,
       height= 6, dpi = 900) 
...
files_intra_mean_sd <- list.files("01_data/10_preprocessed/time_points_separability_evaluation/",
                                  full.names = TRUE,
                                  pattern = "norm_2019_evergreen_intraspecific_mean_sd") 
intra_mean_sd <- lapply(files_intra_mean_sd, read.csv2)


files_inter_mean_diff <- list.files("01_data/10_preprocessed/time_points_separability_evaluation/",
                                    full.names = TRUE,
                                    pattern = "norm_2019_evergreen_interspecific_mean_of_sd") 
inter_mean_diff <- lapply(files_inter_mean_diff, read.csv2)
...
ggsave(paste0("00_documentation/figures/differences/", "norm_2019_evergreen_mean_sd_facet_all_bands",".jpeg"), 
       width= 12,
       height= 6, dpi = 900) 
...
files_intra_mean_sd <- list.files("01_data/10_preprocessed/time_points_separability_evaluation/",
                                  full.names = TRUE,
                                  pattern = "norm_2019_deciduous_intraspecific_mean_sd") 
intra_mean_sd <- lapply(files_intra_mean_sd, read.csv2)


files_inter_mean_diff <- list.files("01_data/10_preprocessed/time_points_separability_evaluation/",
                                    full.names = TRUE,
                                    pattern = "norm_2019_deciduous_interspecific_mean_of_sd") 
inter_mean_diff <- lapply(files_inter_mean_diff, read.csv2)
...
ggsave(paste0("00_documentation/figures/differences/", "norm_2019_deciduous_mean_sd_facet_all_bands",".jpeg"), 
       width= 12,
       height= 6, dpi = 900) 
